...
func TestSudoku(t *testing.T) {
	...
	sudoku3 := internal.Sudoku("020060000,000007009,600400800,100000000,000030000,000000007,003008002,700200000,000010080")
	sudoku4 := internal.Sudoku("000000907,000420180,000705026,100904000,050000040,000507009,920108000,034059000,507000000")

	if !internal.VerifySudoku(sudoku) &&
		!internal.VerifySudoku(sudoku1) &&
		!internal.VerifySudoku(sudoku2) &&
